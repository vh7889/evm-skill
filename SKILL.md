---
name: evm-skill
description: 用于 EVM 链钱包与资产操作。需要批量生成钱包、批量分发/归集原生 gas 代币、批量分发/归集 ERC20 代币、批量合约调用、单钱包转账、单钱包合约调用、单钱包私钥 Bitget 路由 swap、失败重试、断点续跑时使用。
---
...
这个 skill 用于 EVM 链批量与单钱包操作，当前包含 10 个脚本：
- 批量生成钱包
- 批量分发 gas 代币
- 批量归集 gas 代币
- 批量分发 ERC20 代币
