...
ACTION_MAP: Dict[str, Tuple[str, str]] = {
    "supported-chain": ("GET", "/api/v6/dex/balance/supported/chain"),
    "total-value-by-address": ("GET", "/api/v6/dex/balance/total-value-by-address"),
    "all-token-balances-by-address": ("GET", "/api/v6/dex/balance/all-token-balances-by-address"),
    "token-balances-by-address": ("POST", "/api/v6/dex/balance/token-balances-by-address"),
}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="OKX Wallet Portfolio 通用调用")
